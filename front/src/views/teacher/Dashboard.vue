    ...
    <el-row :gutter="20" style="margin-top: 20px">
      <el-col :span="24">
        <el-card>
          ...
          <el-table :data="weeklySchedule" style="width: 100%" v-loading="loading" element-loading-text="加载中...">
...
import { getTeacherDashboard } from '@/api/statistics'
...
const loadAnnouncements = async () => {
  try {
    const res = await getAnnouncementsByRole('teacher', 5)
